...
def parse_args():
    ...
    parser.add_argument("-n","--npd_size", type=int, default=2000,
                        help="size of the non problem domain dataset that should be taken from ImageNet2012")
...
def set_up(args):
    ...
    try:
        ...
        train_model(target_model, od_dataset, target_save_loc)
    ...
    try:
        ...
        train_model(opd_model, pd_dataset, target_save_loc)
